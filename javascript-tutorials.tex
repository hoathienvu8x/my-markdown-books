...
\definecolor{qcolor}{RGB}{246,246,246}
% https://tex.stackexchange.com/a/435632
\newenvironment{displayquote} % https://latex.org/forum/viewtopic.php?t=20207
{\begin{shaded*}\noindent
...
% https://stackoverflow.com/a/62946677 
\lstset{
	tabsize = 2, 
...
\addcontentsline{toc}{section}{\huge The Wikipedia Search App}
...
\addcontentsline{toc}{section}{Create the project folder structure}
...
\begin{figure}[h]
\centering
\includegraphics{wikipedia-logo}
\end{figure}
\newpage
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{JavaScript-Debounce-Function-Project-Structure}
\end{figure}
\addcontentsline{toc}{section}{Build the HTML page}
...
\addcontentsline{toc}{section}{Copy the CSS code}
...
\addcontentsline{toc}{section}{Handle input events}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{JavaScript-Debounce-Function-Input-event}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[scale=1]{JavaScript-Debounce-Function-Input-event-console}
\end{figure}

\addcontentsline{toc}{section}{Fetch search results using Wikipedia API}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{JavaScript-Debounce-Function-too-many-requests.png}
\end{figure}
...
\addcontentsline{toc}{section}{What is debouncing}
...
\addcontentsline{toc}{section}{Develop a reusable debounce function}
...
\end{itemize}
\addcontentsline{toc}{section}{Use the debounce function}
...
\addcontentsline{toc}{section}{Convert the search results to HTML}
...
\addcontentsline{toc}{section}{Strip HTML tags}
...
\addcontentsline{toc}{section}{Highlight the search term}
...
\end{itemize}
\addcontentsline{toc}{section}{Show the search results}
...
\noindent
\addcontentsline{toc}{section}{\huge JavaScript insertAfter}
...
\newpage
\noindent
\addcontentsline{toc}{section}{\huge JavaScript Infinite Scroll}
...
\addcontentsline{toc}{section}{What you're going to build}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{JavaScript-Infinite-Scroll-Example}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{JavaScript-Infinite-Scroll-API}
\end{figure}
...
\addcontentsline{toc}{section}{Create a project structure}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{JavaScript-Infinite-Scroll-Project-Structure}
\end{figure}
\newpage
\addcontentsline{toc}{section}{Add code to the index.html file}
...
\end{itemize}
\addcontentsline{toc}{section}{Making the app.js}
...
\addcontentsline{toc}{section}{The getQuotes() function}
...
\addcontentsline{toc}{section}{The showQuotes() function}
...
\addcontentsline{toc}{section}{Show/hide loading indicator functions}
...
\addcontentsline{toc}{section}{Define control variables}
...
\addcontentsline{toc}{section}{The hasMoreQuotes() function}
...
\addcontentsline{toc}{section}{The loadQuotes() function}
...
\addcontentsline{toc}{section}{Attach the scroll event}
...
\addcontentsline{toc}{section}{Initialize the page}
...
\addcontentsline{toc}{section}{Wrap app.js code in an IIFE}
