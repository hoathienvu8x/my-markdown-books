...
% \begin{figure}[h]
% \centering
% \includegraphics[width=\textwidth]{wikipedia-logo.png}
% \end{figure}
...
% https://tex.stackexchange.com/questions/176966/put-a-grey-background-behind-code-extracts-in-a-latex-document-like-this-site-d
